...
const scenes: Record<string, Scene> = {
  ...
  warehouse: {
    ...
    choices: [{
      text: "Lageret er mørkt",
      nextScene: "doorTask",
      points: 15,
      correctAnswer: true
    }, {
      text: "Lageret er lyst",
      nextScene: "doorTask",
      points: 0,
      correctAnswer: false
    }, {
      text: "Lageret er varmt",
      nextScene: "doorTask",
      points: 0,
      correctAnswer: false
    }]
  ...
  doorTask: {
    ...
    choices: [{
      text: "En som ikke er redd",
      nextScene: "inside",
      points: 15,
      correctAnswer: true
    }, {
      text: "En som er trøtt",
      nextScene: "inside",
      points: 0,
      correctAnswer: false
    }, {
      text: "En som er sulten",
      nextScene: "inside",
      points: 0,
      correctAnswer: false
    }]
...
export default function GameScene() {
  ...
  return <div className="min-h-screen bg-gradient-to-b from-background to-shadow p-4 relative overflow-hidden">
      {/* Rain effect */}
      <div className="absolute inset-0 pointer-events-none opacity-20">
        {[...Array(50)].map((_, i) => <div key={i} className="absolute w-px bg-foreground/30" style={{
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        <Card className="bg-card border-border overflow-hidden animate-fade-in">
          ...
          <div className="p-6 md:p-8">
            ...
            {scene.question && <div className="mb-6 p-4 bg-muted rounded-lg border border-accent/30">
            ...
            {feedback && <div className={`mb-4 p-3 rounded-lg text-center font-bold text-lg ${feedback.includes("Riktig") ? "bg-green-900/30 text-green-400" : "bg-destructive/30 text-destructive-foreground"}`}>
                {feedback}
              </div>}

            {/* Choices */}
            <div className="space-y-3">
              {scene.choices.map((choice, index) => <Button key={index} onClick={() => handleChoice(choice)} disabled={feedback !== ""} className="w-full text-left justify-start h-auto py-4 px-6 text-base md:text-lg bg-muted hover:bg-accent hover:text-accent-foreground transition-all duration-300 border border-border hover:border-accent mx-[10px]">
